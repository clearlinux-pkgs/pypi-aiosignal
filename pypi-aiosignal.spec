...
Source0  : https://files.pythonhosted.org/packages/ba/b5/6d55e80f6d8a08ce22b982eafa278d823b541c925f11ee774b0b9c43473d/aiosignal-1.3.2.tar.gz
...
%prep
%setup -q -n aiosignal-1.3.2
cd %{_builddir}/aiosignal-1.3.2
pushd ..
cp -a aiosignal-1.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735093374
