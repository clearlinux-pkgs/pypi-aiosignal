...
Source0  : https://files.pythonhosted.org/packages/61/62/06741b579156360248d1ec624842ad0edf697050bbaf7c3e46394e106ad1/aiosignal-1.4.0.tar.gz
...
%prep
%setup -q -n aiosignal-1.4.0
cd %{_builddir}/aiosignal-1.4.0
pushd ..
cp -a aiosignal-1.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752156777
